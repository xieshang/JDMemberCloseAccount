...
class Ui_JDMCA(object):
    def setupUi(self, JDMCA):
        ...
        self.widget.setGeometry(QtCore.QRect(11, 521, 324, 25))
        self.widget.setObjectName("widget")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.Btn_InstallPip = QtWidgets.QPushButton(self.widget)
        self.Btn_InstallPip.setObjectName("Btn_InstallPip")
        self.horizontalLayout_3.addWidget(self.Btn_InstallPip)
        self.Combox_mirror = QtWidgets.QComboBox(self.widget)
        ...
        self.widget1 = QtWidgets.QWidget(JDMCA)
        self.widget1.setGeometry(QtCore.QRect(11, 550, 363, 25))
