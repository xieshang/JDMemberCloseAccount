...
class Ui_JDMCA(object):
    def setupUi(self, JDMCA):
        ...
        self.pushButton = QtWidgets.QPushButton(JDMCA)
        self.pushButton.setGeometry(QtCore.QRect(440, 340, 75, 23))
    ...
    def retranslateUi(self, JDMCA):
        ...
        self.pushButton.setText(_translate("JDMCA", "PushButton"))
        self.LogTab.setTabText(self.LogTab.indexOf(self.tab_1), _translate("JDMCA", "Tab 1"))
        self.LogTab.setTabText(self.LogTab.indexOf(self.tab_2), _translate("JDMCA", "Tab 2"))
